--this is not my script i just copied it from here to have a working loadstring for my script hub here is the original github https://github.com/EdgeIY/infiniteyield 
--also this will probally be outdated by the time you use this might update it but probally not gonna
